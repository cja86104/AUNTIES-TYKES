-- ============================================================================
-- Aunties Tykes — initial schema
--
-- Tables derive from src/types.ts. Row Level Security mirrors the isolation
-- rules in src/lib/useFamilyScope.ts: a parent sees only their own family's
-- rows; an admin sees everything.
--
-- Credentials are NOT stored here. Supabase Auth owns them; public.profiles
-- carries the app-level role/family attachment keyed to auth.users.id.
-- ============================================================================
...
create table public.announcements (
  ...
  audience_family_id uuid references public.families(id) on delete cascade,
