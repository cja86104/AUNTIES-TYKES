    ...
    <PageTransition>
      ...
      <div className="mt-6">
        {rows.length === 0 ? (
          <EmptyState
            icon={FolderOpen}
            title={query ? t('documents.noMatchTitle') : t('documents.noDocsTitle')}
            description={query ? t('documents.noMatchDesc') : t('documents.noDocsDesc')}
            action={
              query ? (
                  ...
                  >
                    ...
                    <div className="min-w-[10rem] flex-1">
                      ...
                      <p className="truncate text-xs text-slate-500">
                        {bytes(d.size)} · {mine ? t('documents.youSentThis') : t('documents.shared')} {fmtDate(d.uploadedAt)}
                      </p>
                    </div>
