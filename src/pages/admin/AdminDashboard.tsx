...
export default function AdminDashboard() {
  ...
  return (
    <PageTransition>
      ...
      {/*
        Top-to-bottom order (same on every screen size): Recent conversations,
        Today's roster, Family calendar, Families, Latest announcement,
        Outstanding balance, New inquiries.
      */}
      <div className="mt-6 flex flex-col gap-6">
